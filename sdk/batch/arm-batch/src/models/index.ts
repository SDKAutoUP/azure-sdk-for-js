 ...
 */
export interface BatchAccountDeleteABCHeaders {
  /**
   * The URL of the resource used to check the status of the asynchronous operation.
   */
  location: string;
...
/**
 * Contains response data for the deleteABC operation.
 */
export type BatchAccountDeleteABCResponse = BatchAccountDeleteABCHeaders & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The parsed HTTP response headers.
       */
      parsedHeaders: BatchAccountDeleteABCHeaders;
    };
};
