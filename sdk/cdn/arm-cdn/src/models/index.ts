...
/**
 * Contains response data for the listByResourceGroupX operation.
 */
export type ProfilesListByResourceGroupXResponse = ProfileListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
...
/**
 * Contains response data for the listByResourceGroupXNext operation.
 */
export type ProfilesListByResourceGroupXNextResponse = ProfileListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
